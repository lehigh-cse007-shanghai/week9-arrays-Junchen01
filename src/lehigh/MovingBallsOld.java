...
public class MovingBallsOld extends PApplet{
    ...
    public static void main(String[] args) {
        String[] processingArgs = {"MovingBallsOld"};
        MovingBallsOld movingBallsOld = new MovingBallsOld();
        PApplet.runSketch(processingArgs, movingBallsOld);
    }
}
